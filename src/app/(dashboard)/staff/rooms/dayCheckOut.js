...
import { getRoomData } from "../../../DB/dbFunctions";
...
const dayCheckOut = ({ data, status }) => {
  ...
  const handleAdd = (category, items, index) => {
    ...
    // Copy the current state of roomData
              ...
              <Accordion square={false}>
                <AccordionSummary id="panel1-header">
                  ...
                  >
                    ...
                    <StatusChip value={item.bookingDetails.status} />
                  </Stack>
                </AccordionSummary>
                <AccordionDetails>
                  <Box sx={{ margin: 1 }}>
                    ...
                    <Divider sx={{ m: 1 }} />
                    {Object.values(item.servicesUsed).map((service, i) => (
                      <div key={i}>
                        <Stack
                          direction="row"
                          mt={2}
                        ...
                        >
                          ...
                          <MoreVertIcon
                            onClick={(e) =>
                              handleClickMoreVert(e, service.serviceId)
                            }
                            fontSize="small"
                            sx={{ cursor: "pointer" }}
                          />
                          <Popover
                            ...
                            open={Boolean(anchorEls[service.serviceId])}
                            anchorEl={anchorEls[service.serviceId]}
                            onClose={() =>
                              setAnchorEls((prev) => ({
                                ...prev,
